...
public class _07_operator {
	...
	public static void main(String[] args) {
		...
		//num5에 num5와 num6를 더한 값을 저장
		num5 += num6;
		//num5 == 13
		System.out.println(num5);
		System.out.println("-----------------------------");
		
		//num5에 num5와 num6를 뺀 값을 저장
		//13 - 3
		num5 -= num6;
		//num5 = 10
		System.out.println(num5);
		...
		//num5에 num5와 num6를 나눈 나머지 값을 저장
		//10 % 3
		num5 %= num6;
		//num5 = 1
		System.out.println(num5);
		...
		//5. 비교연산자
		//비교연산자는 두 변수 값을 비교하여 true, false를 리턴하는 연산자
		int num8 = 10;
		int num9 = 20;
